...
class HapiBot(HelperBot):
    ...
    SUFFIXES = [".py", ".md"]
    def __init__(self):
        super().__init__(HapiBot.REPO_NAME, HapiBot.REPO_URL, HapiBot.SUFFIXES)
...
class KamodoBot(HelperBot):
    ...
    SUFFIXES = [".py", ".md"]
    def __init__(self):
        super().__init__(KamodoBot.REPO_NAME, KamodoBot.REPO_URL, KamodoBot.SUFFIXES)
...
class PlasmapyBot(HelperBot):
    ...
    SUFFIXES = [".py", ".md"]
    def __init__(self):
        super().__init__(PlasmapyBot.REPO_NAME, PlasmapyBot.REPO_URL, PlasmapyBot.SUFFIXES)
...
class PysatBot(HelperBot):
    ...
    def __init__(self):
        super().__init__(PysatBot.REPO_NAME, PysatBot.REPO_URL, PysatBot.SUFFIXES)
...
class PyspedasBot(HelperBot):
    ...
    SUFFIXES = [".py", ".md"]
    def __init__(self):
        super().__init__(PyspedasBot.REPO_NAME, PyspedasBot.REPO_URL, PyspedasBot.SUFFIXES)
...
class SpacepyBot(HelperBot):
    ...
    SUFFIXES = [".py", ".md"]
    def __init__(self):
        super().__init__(SpacepyBot.REPO_NAME, SpacepyBot.REPO_URL, SpacepyBot.SUFFIXES)
...
class SunpyBot(HelperBot):
    ...
    SUFFIXES = [".py", ".rst"]
    def __init__(self):
        super().__init__(SunpyBot.REPO_NAME, SunpyBot.REPO_URL, SunpyBot.SUFFIXES)
...
class PyhcBot(HelperBot):
    ...
    SUFFIXES = [".md", ".yml"]
    def __init__(self):
        super().__init__(PyhcBot.REPO_NAME, PyhcBot.REPO_URL, PyhcBot.SUFFIXES)
